  ...
  return (
    <div className="w-full h-full flex flex-col">
      ...
      <div className="w-full h-full flex flex-col items-center justify-center">
        <h1 className="text-2xl font-semibold mt-1 mb-8 text-center uppercase tracking-widest">
          Welcome to Operator Desktop
        </h1>
        ...
        <div className="flex gap-6">
          <Card className="w-[400px] py-5">
            <CardHeader className="px-5">
              ...
              <CardDescription>
                Use the Operator model to automate and complete tasks directly on
          ...
          <Card className="w-[400px] py-5">
            <CardHeader className="px-5">
              ...
              <CardDescription>
                Let the Operator model help you automate browser tasks, from
