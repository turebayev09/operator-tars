  ...
  return (
    ...
    >
      <div className="flex draggable-area">
        {/* Logo */}
        <div className="flex items-center mr-auto -ml-1">
          <img src={logoBlack} alt="logo" className="h-6 dark:hidden" />
          <img src={logoWhite} alt="logo" className="h-6 hidden dark:block" />
          <span className="ml-1.5 font-bold text-sm tracking-widest dark:text-white uppercase">Operator</span>
        </div>
        {/* Mode Badge */}
