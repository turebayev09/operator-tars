...
**[Seed1.5-VL](https://raw.githubusercontent.com/-Seed/Seed1.5-VL/refs/heads/main/README.md)** is a powerful and efficient vision-language foundation model designed for advanced general-purpose multimodal understanding and reasoning, Seed1.5-VL has been deployed on [Volcano Engine](https://www.volcengine.com/product/doubao), The Model ID is `doubao-1-5-thinking-vision-pro-250428`.
...
::: tip TIP
If you encounter any issues, please feel free to report them to us on [Github](https://github.com//Desktop App/issues).
:::
