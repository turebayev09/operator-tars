...
| `visual-grounding` | Operates with GUI-based agents ([TARS](https://seed-tars.com/) / [Doubao 1.5 VL](https://www.volcengine.com/docs/82379/1554521)), without using DOM-related tools. |
...
::: tip Comparison with Desktop App
If you’ve used Desktop App, you can understand this as a combination of the Desktop App browser operator, navigation tools, and information extraction tools. 
:::
