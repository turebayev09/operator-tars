...
- [`multimodal/tarko/agent/examples/tool-calls/basic.ts`](https://github.com//Desktop App/blob/main/multimodal/tarko/agent/examples/tool-calls/basic.ts) - Basic tool calls
- [`multimodal/tarko/agent/examples/streaming/tool-calls.ts`](https://github.com//Desktop App/blob/main/multimodal/tarko/agent/examples/streaming/tool-calls.ts) - Streaming with tools
- [`multimodal/tarko/agent/examples/model-providers/`](https://github.com//Desktop App/tree/main/multimodal/tarko/agent/examples/model-providers) - Different model providers
...
git clone https://github.com//Desktop App.git
cd Desktop App/multimodal/tarko/agent
