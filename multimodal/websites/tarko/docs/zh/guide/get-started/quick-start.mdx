...
- [`multimodal/tarko/agent/examples/tool-calls/basic.ts`](https://github.com//Desktop App/blob/main/multimodal/tarko/agent/examples/tool-calls/basic.ts) - 基础工具调用
- [`multimodal/tarko/agent/examples/streaming/tool-calls.ts`](https://github.com//Desktop App/blob/main/multimodal/tarko/agent/examples/streaming/tool-calls.ts) - 流式工具调用
- [`multimodal/tarko/agent/examples/model-providers/`](https://github.com//Desktop App/tree/main/multimodal/tarko/agent/examples/model-providers) - 不同 Model Provider
