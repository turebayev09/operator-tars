...
**UI TARS Desktop** is exclusively designed for executing tasks as a [GUI Agent](https://arxiv.org/abs/2411.18279). It relies solely on the [TARS](https://github.com//TARS) model for automating GUI tasks.

- **Latest Version**: [v0.0.8](https://github.com//Desktop App/releases/tag/v0.0.8) 
- **Supported Platforms**: **Mac** and **Windows**
- **Model Compatibility**: Limited to [TARS](https://github.com//TARS) Model 
- **Applicable Scenarios**: GUI-based control of computers (i.e., desktop automation)
- **Quick Start**: https://github.com//Desktop App/blob/main/docs/quick-start.md
...
> [!IMPORTANT]
> It’s important to note that Agent TARS does not support **TARS** models. Claude remains the temporary best option, for the latest information on model support, check out [GitHub Discussion #377](https://github.com//Desktop App/discussions/377).

- **Latest Version**: [Agent-TARS-v1.0.0-alpha.7](https://github.com//Desktop App/releases/tag/Agent-TARS-v1.0.0-alpha.7) 
...
The **UI TARS Desktop** application and **Agent TARS App** serve unique purposes and target different scenarios. Currently, **UI TARS Desktop** supports TARS models, perfect for system-level GUI automation, while the experimental **Agent TARS App** is limited to Mac users and focuses on browser-based tasks. Please note that the app does not support the TARS model "yet".

Choose the tool that fits your needs and compatibility, and for installation assistance or troubleshooting, visit the [GitHub Issues page](https://github.com//Desktop App/issues). Stay tuned for updates aimed at enhancing functionality and unifying features across these applications!
