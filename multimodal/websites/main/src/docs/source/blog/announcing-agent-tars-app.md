...
> **DISCLAIMER**: Agent TARS is still in **Technical Preview** stage and not stable yet. It's not recommended to use it in production. If you run into any issues, we welcome feedback on [Github](https://github.com//Desktop App) or on [Twitter](https://x.com/agent_tars).

### Install

Visit [Releases](https://github.com//Desktop App/releases?q=Agent+Tars&expanded=true) page to download the latest desktop package of Agent TARS.
...
- Github: https://github.com//Desktop App
