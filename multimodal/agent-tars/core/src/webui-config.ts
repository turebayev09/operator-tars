...
export const AGENT_TARS_WEBUI_CONFIG: AgentWebUIImplementation = {
  ...
  welcomeCards: [
    ...
    },
    {
      ...
      image:
        'https://lf3-static.bytednsdoc.com/obj/eden-cn/zyha-aulnh/ljhwZthlaukjlkulzlp/storage/general/httpsbeianmiitgovcnintegratedrecordquery-httpswwwc-120388.jpg',
    },
    {
    ...
    {
      title: 'In-depth Research on  Web Infra',
      category: 'Research',
      prompt:
        '帮我深度调研一下  Web Infra，给出一份详细的调研报告\r\n\r\n我期待覆盖的信息： \r\n\r\n1. 团队介绍\r\n2. 主要的开源项目、贡献者；\r\n3. 应用场景； \r\n4. 项目活跃状态；\r\n5. 社区影响力；\r\n6. 技术蓝图；\r\n7. 你的思考；\r\n\r\n要求报告采用 Markdown 输出中文，最后写入文件，同时，并使用 HTML 绘制一个图文并茂的 Slide，介绍  Web Infra',
      image:
        'https://lf3-static.bytednsdoc.com/obj/eden-cn/zyha-aulnh/ljhwZthlaukjlkulzlp/storage/general/-web-infra-1-002133.jpg',
    },
    {
