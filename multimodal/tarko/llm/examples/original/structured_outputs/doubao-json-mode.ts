...
`;
  ...
  const stream = await openai.chat.completions.create({
    ...
    // https://cloud..net/docs/ark/docs/664afad9e16ff302cb5c0706/682bfcaebcd01f0508f0cb72?source=search&from=search_bytecloud&x-resource-account=public&x-bc-region-id=
    response_format: {
      type: 'json_object',
    },
    stream: true,
