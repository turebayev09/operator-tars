...
```bash
git clone https://github.com//Desktop App
cd multimodal
pnpm bootstrap
```
...
```bash
/path/to/Desktop App/multimodal/agent-tars-cli/bin/cli.js \
--provider=foo \
--model=bar \
--apiKey=baz \
--share-provider=https://aipa..net/api/file-upload
```

Make sure to replace `/path/to/Desktop App/multimodal/agent-tars-cli/bin/cli.js` with the actual path on your system.
