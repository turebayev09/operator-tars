...
```ts
// router.ts
import { initIpc } from '@TARS/electron-ipc/main';
import { z } from 'zod';
...
```ts
// main.ts
import { registerIpcMain, createServer } from '@TARS/electron-ipc/main';
...
```ts
// renderer.ts
import { createClient } from '@TARS/electron-ipc/renderer';
