# Browser Operator for TARS

[![License](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](https://github.com//Desktop App/LICENSE)

A browser automation operator for TARS that enables controlling web browsers through natural language instructions.

## Features

- Control web browsers using [TARS](https://github.com//TARS)(Vision-Lanuage Model)
...
- Integration with [TARS SDK](https://github.com//Desktop App/blob/main/docs/sdk.md)

## Installation

```bash
npm install @TARS/operator-browser
```
...
import { GUIAgent, StatusEnum } from '@TARS/sdk';
import { BrowserOperator } from '@TARS/operator-browser';
...
async function main() {
 ...
 await agent.run('Search for TARS on the website');
...
The main class that implements the TARS operator interface for browser control.
...
Apache-2.0 © 2025 , Inc. and its affiliates.
