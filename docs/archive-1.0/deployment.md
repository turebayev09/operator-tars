...
中文版: [GUI模型部署教程](https://.sg.larkoffice.com/docx/TCcudYwyIox5vyxiSDLlgIsTgWf#U94rdCxzBoJMLex38NPlHL21gNb)
...
- [2B-SFT](https://huggingface.co/-research/TARS-2B-SFT)
- [7B-SFT](https://huggingface.co/-research/TARS-7B-SFT)
- [7B-DPO](https://huggingface.co/-research/TARS-7B-DPO)
- [72B-SFT](https://huggingface.co/-research/TARS-72B-SFT)
- [72B-DPO](https://huggingface.co/-research/TARS-72B-DPO)
...
```bash
python -m vllm.entrypoints.openai.api_server --served-model-name TARS --model <path to your model>
```
