...
1. Get your TARS Service from [TARS](https://github.com//TARS)
2. Get your Browserbase API key and project ID from [Browserbase](https://www.browserbase.com)

Update `.env.local` with your API keys:

- `UI_TARS_BASE_URL`: Your TARS Base Url
- `UI_TARS_API_KEY`: Your TARS API Key
- `UI_TARS_MODEL`: Your TARS Model
